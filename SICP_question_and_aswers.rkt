;; Design of a procedure that evolves an iterative exponentiation process that uses successive 
...
;;Average-damp procedure --- takes its argument a procedure f and returns as its value as a procedure, that when applied to a number
...
;; Note that cond-frac can be expresseda as: f(x) = { Ni / Di + F(i +1) if i <= k,  0 else
...
;;; (define k 5) ; or whatever value you want
